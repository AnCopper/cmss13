...
//---------- IFM ----------//
#define JOB_IFM_FIELD_DOCTOR "IFM - Field Doctor"
#define JOB_IFM_CHIEF_MEDICAL_OFFICER "IFM - Chief Medical Officer"
#define JOB_IFM_SECURITY_CONTRACTOR "IFM - Security Contractor"
#define JOB_IFM_SYNTHETIC "IFM - Medical Support Synthetic"
